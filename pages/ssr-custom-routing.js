      ...
      <div style={styles.content}>
        <div style={styles.infoTextContainer}>
          ...
          <p>
            ...
            work, it&lsquo;s only for the purpose of illustrating what can be
            done):
            <ul>
              <li>
          ...
          <p>
            This page leverages the standard `redirect` and
            &lsquo;notFound&lsquo; objects returned by `getServerSideProps` to
            perform the custom routing.
          </p>
          <p>User&lsquo;s email is verified: {emailVerified ? "yes" : "no"}</p>
        </div>
        <DemoPageLinks />
      </div>
    </div>
